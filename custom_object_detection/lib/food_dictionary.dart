...
Map<String, FoodData> foodDictionary = {
  ...
  "Dragon Fruit" : FoodData("Dragon Fruit", 102, 2, 0, 13, 0,8),
  "Donuts" : FoodData("Donuts", 269, 4, 260, 25, 15,15),
  "Baked Beans" : FoodData("Banana", 105, 1.3, 1, 27, 0.4,14),
  "Popcorn" : FoodData("Banana", 105, 1.3, 1, 27, 0.4,14),
  "Potato Chips" : FoodData("Banana", 105, 1.3, 1, 27, 0.4,14),
  "Barbecue Ribs" : FoodData("Banana", 105, 1.3, 1, 27, 0.4,14),
